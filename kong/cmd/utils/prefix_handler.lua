  ...
  do
    for _, target in ipairs({ "proxy", "admin", "status" }) do
      ...
      if ssl_enabled and #ssl_cert == 0 and #ssl_cert_key == 0 then
        ...
        if kong_config.ssl_cipher_suite == "modern" or kong_config.ssl_cipher_suite == "intermediate" then
          ssl_cert[1]     = kong_config[prefix .. "ssl_cert_default_ecdsa"]
          ssl_cert_key[1] = kong_config[prefix .. "ssl_cert_key_default_ecdsa"]
          ssl_cert[2]     = kong_config[prefix .. "ssl_cert_default"]
          ssl_cert_key[2] = kong_config[prefix .. "ssl_cert_key_default"]
